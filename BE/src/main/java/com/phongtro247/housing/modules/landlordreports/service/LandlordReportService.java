package com.phongtro247.housing.modules.landlordreports.service;
...
import com.phongtro247.housing.modules.contracts.repository.ContractRepository;
import com.phongtro247.housing.modules.landlordreports.dto.ExpenseItemResponse;
import com.phongtro247.housing.modules.landlordreports.dto.ExpenseListResponse;
import com.phongtro247.housing.modules.landlordreports.dto.ExpenseSummaryResponse;
...
public class LandlordReportService {
    ...
    private String expenseCategory(String description) {
        ...
        if (value.contains(MessageCatalog.POSTING_FEE_CATEGORY.toLowerCase(Locale.ROOT))) {
            return MessageCatalog.POSTING_FEE_CATEGORY;
        }
        if (value.contains(MessageCatalog.HOT_LISTING_FEE_CATEGORY.toLowerCase(Locale.ROOT))) {
            return MessageCatalog.HOT_LISTING_FEE_CATEGORY;
        }
