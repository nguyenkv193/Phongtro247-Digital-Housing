...
const ContractManagement = () => {
    ...
    const handleTroChange = e => {
        ...
        if (selectedListing && selectedListing.price) {
            ...
            const priceValue = parseFloat(selectedListing.price);
    ...
    const handleSave = async () => {
        try {
            ...
            const selectedListing = listings.find(l => l.id === formData.tro_id);
