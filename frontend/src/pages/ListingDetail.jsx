...
const ListingDetail = () => {
    ...
    const getSurroundingIcon = surrounding => {
    ...
    const handleShareToFacebook = () => {
        const shareUrl = import.meta.env.VITE_SHARE_URL || API_URL;
    ...
    const handleToggleFavorite = async () => {
        ...
        try {
            const newState = await contextToggleFavorite(id);
    ...
    const fetchReviews = async () => {
        try {
            const response = await axios.get(`${API_URL}/api/reviews/listing/${id}`);
    ...
    const surroundings =
        typeof listing.surroundings === 'string'
            ? JSON.parse(listing.surroundings)
