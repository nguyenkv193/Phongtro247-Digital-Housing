import { faEnvelope, faLocationArrow, faPhone, faQrcode } from '@fortawesome/free-solid-svg-icons';
                                ...
                                <div className="h-[95px] flex flex-col gap-y-2">
                                    <div className="flex h-[47px] w-[155px] items-center gap-2 rounded-md bg-black px-3 text-white">
                                        ...
                                        <span className="flex flex-col leading-tight">
                                            <span className="text-[9px]">Tải trên</span>
                                            <span className="text-base font-semibold">App Store</span>
                                        </span>
                                    </div>
                                    <div className="flex h-[41px] w-[155px] items-center gap-2 rounded-md bg-black px-3 text-white">
                                        <FontAwesomeIcon icon={faGooglePlay} className="text-xl" />
                                        <span className="flex flex-col leading-tight">
                                            <span className="text-[9px]">Tải xuống từ</span>
