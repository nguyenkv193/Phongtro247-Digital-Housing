...
import { useLocation, Link, useSearchParams } from '@/lib/navigation/router-compat';
...
import Filter from '@/features/listings/components/Filter';
...
const RentalListPage = () => {
    ...
    const [searchResults, setSearchResults] = useState<ListingLocation[]>([]);
    ...
    const getPriceRange = (priceStr: string): RangeValue => {
        const priceMap: Record<string, RangeValue> = {
    ...
    const getAreaRange = (areaStr: string): RangeValue => {
        const areaMap: Record<string, RangeValue> = {
